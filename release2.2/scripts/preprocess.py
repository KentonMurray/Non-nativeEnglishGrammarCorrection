            ...
            for slistIndex in xrange(len(doc.sentences)):
                ...
                for sentid in xrange(len(slist)):
                    ...
                    for m in doc.mistakes:
                        ...
                        #print >> sys.stderr, wdstart, wdend, len(table), m

                        # build annotation string for .conll.ann file
                        annotationStr  = '<MISTAKE '
                        annotationStr += 'nid="' + table[wdstart][0] + '" '          #nid
                        annotationStr += 'pid="' + str(table[wdstart][1]) + '" '       #start_par
                        ...
                        annotationStr += '<CORRECTION>' + headText + m['correction'] + tailText + '</CORRECTION>\n'
                        annotationStr += '</MISTAKE>\n'
                        ...
                        m2AnnotationStr +=  (headText + m['correction'] + tailText).replace('\n', '')  + '|||'
